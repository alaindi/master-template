...
<section id="author">
    <div class="container">
        ...
        ?>
        <div class="row">
            <div class="col-md-4 col-sm-12 order-lg-last order-md-last order-sm-first order-xs-first">
              <div class="img-cont">
                        ...
                        <div data-aos="fade-left"
                            ...
                            <div class="book-type"> 
                                <?php
                                    ...
                                    if( $otherorderfields[0]['other-buy-the-book'] != ""){
                                      echo '<a href="'. $otherorderfields[0]['other-buy-the-book'] .'" target="_blank" class="btn-style">Buy Now</a>'; 
                                    }
                                ?>
                            </div>
                            <div class="book-store">
